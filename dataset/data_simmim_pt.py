...
from .datamodule import load_from_csv, CustomDataset
...
def build_loader_simmim(config):
    ...
    train_data = load_from_csv("./data", "ageutk_full.csv", append_path=config.DATA.DATA_PATH)
    dataset = CustomDataset(transform=transform, dataset=train_data)
